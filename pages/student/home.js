...
const StudentHome = () => {
  ...
  function queryCourseType(type) {
    ...
    console.log(curricularcoursesList + 'Data');
    curricularcoursesList.map((course) => {
      console.log(Object.keys(course).length + 'course');
      if (
        course[fbc.COURSE_CODE] ===
        type + '_' + courseDetails[fbc.COURSE_CODE]
      ) {
        window.open(
                    ...
                    >
                      <h3 className="card-title align-items-center justify-content-between w-100 flex-row pt-5 px-0  mb-3">
                        <div className="d-flex flex-column mb-auto ">
                          <span className="fs-3x fs-md-5 my-2 text-white fw-bolder">
                            Hi {utility.get_keyvalue(USER_FULLNAME)}!
                          </span>
                          <span className="fs-1x fs-md-5 mb-2 fw-semibold text-white">
                          ...
                          <div className="w-50 mw-200px h-120px px-2 pb-4">
                            ...
                            >
                              <div className="card-body d-flex ">
                                <img
                                  className="img-fluid h-100px m-auto"
                          ...
                          <div className="w-50 mw-200px h-120px px-2 pb-4">
                            ...
                            >
                              <div className="card-body d-flex ">
                                <img
                                  className="img-fluid h-100px m-auto"
                                  src="../../assets/images/homeschooling.svg"
                                ></img>
                              </div>
                              <div className="card-footer d-flex px-2 py-3">
                                <span className="fs-4 fs-md-6 text-center mx-auto fw-bolder">
