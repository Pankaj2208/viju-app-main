  ...
  async function getAllCourses() {
    ...
    try {
      ...
      const q = query(
        CourseReF,
        where(fbc.COURSE_STATUS, '==', true),
        orderBy(`${fbc.COURSE_BOARD}.code`),
        where(`${fbc.COURSE_BOARD}.code`, '!=', 'EXTRACURRICULAR'),
        orderBy(fbc.COURSE_NAME)

        //where(`${fbc.COURSE_BOARD}.code`, '!=', 'EXTRACURRICULAR'),
        // where(`${fbc.COURSE_CODE}`, '==', 'CBSE-1', false),
        //orderBy(fbc.COURSE_NAME)
        //where(`${fbc.COURSE_BOARD}.code`, '_.isEqual', 'EXTRACURRICULAR'),
        //where(`${fbc.COURSE_BOARD}.code`, '!=', 'EXTRACURRICULAR'),
        //where(`${fbc.COURSE_BOARD}.code`, '!==', 'EXTRACURRICULAR'),
        //where(`${fbc.COURSE_BOARD}.code`, '$ne', 'EXTRACURRICULAR'),
        //where(`${fbc.COURSE_BOARD}.code`, '!', 'EXTRACURRICULAR'),
        //where(`${fbc.COURSE_BOARD}.code`, '>', 'EXTRACURRICULAR').or(
        //   `${fbc.COURSE_BOARD}.code`,
        //   '<',
        //   'EXTRACURRICULAR'
        // ),
        // where(
        //   JSON.stringify(`${fbc.COURSE_BOARD}.code`),
        //   '!=',
