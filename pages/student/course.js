            ...
            >
              {selectedcourseUID == null ? (
                <>
                  ...
                  > */}
                  {/* <span className="fs-1 mb-1 fw-bolder px-12">
                      As Per New Education Policy Year 2020
                    </span>
                    <li className=" fw-bold list-group px-12">
                      FUNDAMENTAL - Jr.KG , Sr.KG, 1st & 2nd
                    </li>
                    <li className=" fw-bold list-group px-12">
                      PREPATORY - 3th, 4th & 5th
                    </li>
                    <li className=" fw-bold list-group px-12">
                      MIDDLE - 6th, 7th & 8th
                    </li>
                    ...
                    <span className="fs-1 mb-1 fw-bolder px-12">
                      We have prepared the syllabus accordingly for skill
                      development.
                    </span> */}
                  {/* </div> */}
                  <div className="container-fluid px-0">
                    {/* <div className="d-flex flex-row flex-nowrap gap-2 hover-scroll-x">
                      ...
                      }} className="rounded-4 col-4 col-lg-1 h-150px my-2 card"></div>
                      <div style={{
                        backgroundColor: courseDetails != null ? (fbc.COURSECOLORS[courseDetails?.[fbc.COURSE_COLOR]] || [fbc.COURSECOLORS.YELLOW]) : "#FFF"
                      }} className="rounded-4 col-4 col-lg-1 h-150px my-2 card"></div>
                      <div style={{
              ...
              <div className="tab-content mt-3" id="subjectTabContent">
                {subjectList.map((subject, index) => {
                  return (
                    <div
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="card">
                                  ...
                                  {/* <img
                                          className="bg-white h-100 img-thumbnail rounded-top-4 card-img-top"
