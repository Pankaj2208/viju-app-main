                    ...
                    <div className="card-header py-2 px-2">
                      <div className="card-title d-flex flex-row justify-content-between align-items-center w-100 mb-0 m-0">
                        <div className="d-flex flex-row align-items-center gap-4">
                          <img
                            src={subjectDetails[fbc.SUBJECT_THUMBNAILURL]}
                            className="bg-white rounded  w-75px h-75px"
                          ></img>

                          <div className="d-flex flex-column">
                            <span className="fs-1 mb-1 fw-bolder">
                              {subjectDetails[fbc.SUBJECT_NAME]}
                            </span>
                            <span className="fs-6 text-muted">
                              {utility.padwithzero(
                                subjectDetails[fbc.SUBJECT_LESSONSUIDARRAY]
                                  .length
                              )}{' '}
                              Lessons
                            </span>
                    ...
                    >
                      ...
                      >
                        {lessons.map((lesson) => {
                          return (
                            <div
                              id={'accordion_' + lesson[fbc.LESSON_UID]}
                              key={lesson[fbc.LESSON_UID]}
                              className="accordion-item"
                            >
                              <div
                                className="accordion-header d-flex flex-row bg-light "
                                data-bs-toggle="collapse"
                                data-bs-target={
                                  '#kt_accordion_body_' + lesson[fbc.LESSON_UID]
                                }
                                aria-expanded="false"
                                aria-controls={
                                  'kt_accordion_body_' + lesson[fbc.LESSON_UID]
                              ...
                              >
                                <div className="d-flex flex-row col-10 gap-2 align-items-center px-4">
                                  <img
                                    src={lesson[fbc.LESSON_THUMBNAILURL]}
                                    className=" bg-white rounded shadow-md   w-30px h-30px"
                                  ></img>
                              ...
                              <div
                                ...
                                className={
                                  ...
                                  (lessonUID !== null
                                    ? lessonUID === lesson[fbc.LESSON_UID]
                                      ? ' show '
                                      : ''
                                    : '')
                                }
                              >
                                <div className="accordion-body p-2">
                                  ...
                                  >
                                    <li className="nav-item g-5">
                                      <button
                                        ...
                                        id={
                                          'content_tabbtn_' +
                                          lesson[fbc.LESSON_UID]
                                        }
                                        href={
                                          '#content_' + lesson[fbc.LESSON_UID]
                                        }
                                      >
                                        Content
                                      </button>
                                    ...
                                    <li className="nav-item g-5">
                                      <button
                                        ...
                                        href={
                                          '#assesment_' + lesson[fbc.LESSON_UID]
                                        }
                                      >
                                        Assesment
                                      </button>
                                  ...
                                  >
                                    ...
                                    >
                                      {Object.keys(
                                        lesson[fbc.LESSON_CONTENT]
                                      ).map((key, index) => {
                                        var content =
                                          lesson[fbc.LESSON_CONTENT][key];
                                        return (
                                          <a
                                            onClick={(e) => {
                                              window.location =
