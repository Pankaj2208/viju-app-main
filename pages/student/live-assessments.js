  ...
  useEffect(() => {
    ...
    asmts.map((asmt) => {
      ...
      if (appearedasmts[asmt[fbc.ASMT_UID]] !== undefined) {
        appearedStatus = `<span class="badge py-3 px-4 rounded-pill fs-8 badge-primary badge me-3">${
          appearedasmts[asmt[fbc.ASMT_UID]][fbc.STDASMT_STATUS]
        }</span>`;
      }
      ...
      <div class="d-flex flex-row align-items-center w-75"> 
          ...
          <div class="d-flex flex-column">
            ...
            <span class="text-xs text-dark fw-semibold">${
              asmt[fbc.ASMT_CODE]
            } | ${asmt[fbc.ASMT_DURATION]}mins | ${
        asmt[fbc.ASMT_TOTAL]
      } Marks</span>
                    ...
                    <div className="d-flex flex-row align-items-center gap-4">
                      <div className="d-flex flex-column">
                        ...
                        <span className="fs-6 text-muted">
                          {utility.padwithzero(asmts.length)} Assesments
                        </span>
                      </div>
                    </div>
                  </div>
