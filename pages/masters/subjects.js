...
const Subjects = () => {
  ...
  function viewSubject(subject_uid) {
    ...
    window.open(
      window.location.origin +
        '/masters/course-details?view=' +
        subDoc[fbc.SUBJECT_COURSE].uid +
        '&subject=' +
        subject_uid,
      '_blank'
    );
  ...
  async function getAllSubjects() {
    ...
    try {
      ...
      let q = query(SubjectReF, ...params, orderBy(fbc.SUBJECT_CODE));
      ...
      allSubjectDocs.map((subjectDoc, index) => {
        ...
        var rowitem = `<tr>
                        ...
                        <td class="text-gray-800 mb-1">${
                          subjectDoc[fbc.SUBJECT_COURSE].name
                        }</td>
                        <td class="text-gray-800 mb-1">${
                          subjectDoc[fbc.SUBJECT_NAME]
                        }</td>
                        <td class="text-gray-800 mb-1">${
                          subjectDoc[fbc.SUBJECT_CODE]
                        }</td>
