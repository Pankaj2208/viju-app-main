...
import SubjectList from '../../components/masters/subjectlist-Gk';
...
const CourseDetails = () => {
  ...
  async function fetchCoursedetails(uid) {
    utility.showloading();
    const docRef = doc(db, fbc.GKCOURSE_COLLECTION, uid);
              ...
              {courseDetails != null ? (
                <>
                  <div className="card h-100">
                    <div className="card-header py-2 px-4 pb-0">
                      <div className="card-title d-flex flex-row justify-content-between align-items-center w-100 mb-0">
                        <div className="d-flex flex-row align-items-center gap-4">
                          <img
                            src={courseDetails[fbc.GKCOURSE_THUMBNAILURL]}
                            className="mb-2 bg-white rounded  w-100px h-100px"
                          ></img>

                          <div className="d-flex flex-column mb-4">
                            <span className="fs-2 mb-1 fw-bolder">
                              {courseDetails[fbc.GKCOURSE_NAME]}
                            </span>
                            <span className="fs-6 text-muted">
                              {courseDetails[fbc.GKCOURSE_CODE] +
                                ' | ' +
                                courseDetails[fbc.GKCOURSE_BOARD].code +
                                ' | ' +
                                courseDetails[fbc.GKCOURSE_FIELD]}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="d-flex flex-row">
                          <div className="d-flex flex-column">
                            {courseDetails[fbc.GKCOURSE_STATUS] ? (
                              <>
                            ...
                            <span className="fs-6 mt-2 text-muted text-end">
                              Last Updated :{' '}
                              {
                                courseDetails[fbc.GKCOURSE_LOGS][
                                  courseDetails[fbc.GKCOURSE_LOGS].length - 1
                                ]['date']
                              }
                            </span>
                          </div>
                    ...
                    >
                      <SubjectList
                        courseuid={courseDetails[fbc.GKCOURSE_UID]}
