              ...
              {courseDetails != null ? (
                <>
                  <div className="card h-100">
                    <div className="card-header py-2 px-4 pb-0">
                      <div className="card-title d-flex flex-row justify-content-between align-items-center w-100 mb-0">
                        <div className="d-flex flex-row align-items-center gap-4">
                          <img
                            src={courseDetails[fbc.COURSE_THUMBNAILURL]}
                          ...
                          <div className="d-flex flex-column mb-4">
                            ...
                            <span className="fs-6 text-muted">
                              {courseDetails[fbc.COURSE_CODE] +
                                ' | ' +
                                courseDetails[fbc.COURSE_BOARD].code +
                                ' | ' +
                                courseDetails[fbc.COURSE_FIELD]}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="d-flex flex-row">
                          <div className="d-flex flex-column">
                            ...
                            <span className="fs-6 mt-2 text-muted text-end">
                              Last Updated :{' '}
                              {
                                courseDetails[fbc.COURSE_LOGS][
                                  courseDetails[fbc.COURSE_LOGS].length - 1
                                ]['date']
                              }
                            </span>
                          </div>
                    ...
                    >
                      <SubjectList
                        courseuid={courseDetails[fbc.COURSE_UID]}
