...
var WebApp = (function () {
  ...
  return {
    init: function () {
      ...
      // window.Sortable = require('@shopify/draggable/lib/sortable').default;
      ...
      appendScript('../../../assets/plugins/formvalidation/dist/js/FormValidation.Full.min.js');
      appendScript('../../../assets/plugins/formvalidation/dist/js/plugins/Bootstrap5.min.js');
