...
const AssesmentDetails = ({ asmtDetails, setSTDAsmtDetails }) => {
  ...
  async function startAssesment() {
    utility.info_alert(
      'Start ' + asmtDetails[fbc.ASMT_TITLE] + ' Assessment?',
    ...
    var uploadData = async function () {
      ...
      if (addorUpdateAssessment.status) {
        ...
        //     }
        // }, { merge: true });
        const studentAsmtdocRef = doc(
          db,
          fbc.STDASMT_COLLECTION,
          addorUpdateAssessment.data
        );
                ...
                <div className="d-flex flex-row align-items-center w-100  justify-content-between gap-4">
                  <div className="d-flex flex-column ps-4">
                    <div className="d-flex flex-row">
                      {asmtDetails[fbc.ASMT_ISPRACTICE] ? (
                    ...
                    <span className="display-6 mb-2 fw-bolder">
                      {asmtDetails[fbc.ASMT_TITLE]}
                    </span>
                    <span className="fs-4 text-muted">
                      {asmtDetails[fbc.ASMT_CODE]}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="card-body p-4 d-flex flex-column">
              <div className="d-flex flex-row">
                <div className="d-flex flex-row px-4 mx-auto gap-2">
                  ...
                  <div className="d-flex flex-column border-end pe-4 mx-4">
                    <span className="fs-3 mb-1 fw-bolder text-center">
                      {utility.padwithzero(
                        Object.keys(asmtDetails[fbc.ASMT_QUESTIONS]).length
                      )}
                    </span>
                    <span className="fs-5 text-muted fw-semibold  text-center">
                      Questions
                  ...
                  <div className="d-flex flex-column">
                    <span className="fs-3 mb-1 fw-bolder text-center">
                      {utility.padwithzero(asmtDetails[fbc.ASMT_TOTAL])}
                    </span>
                    <span className="fs-5 text-muted fw-semibold  text-center">
                      Marks
                    </span>
              ...
              <div className="d-flex flex-row align-items-center w-100 justify-content-between">
                <div className="d-flex flex-column ps-4  w-100 ">
                  <span className="fs-4 w-100 text-center fw-bolder">
            ...
            <div className="card-footer p-3 bg-light ">
              <div className="d-flex flex-row m-2">
                <button
                  ...
                  className="btn btn-block w-100 btn-primary fs-4 hover-elevate-up"
                >
                  Start Assessment
                </button>
              </div>
