        ...
        {(() => {
          switch (content[fbc.CONTENT_FILE].mime) {
            case 'application/pdf':
              return (
                <>
                  <PDFViewer pdfURL={content[fbc.CONTENT_FILE].url} />
                </>
              );
            case 'image/jpeg':
              return (
                <>
                  <ImageViewer url={content[fbc.CONTENT_FILE].url} />
                </>
              );
            case 'video/url':
              return (
                <>
                  <VideoViewer
                    url={content[fbc.CONTENT_FILE].url}
                    onYoutube={content[fbc.CONTENT_ONYOUTUBE]}
                  />
                </>
              );
            default:
