...
const MCQQuestion = ({ questionUID }) => {
  ...
  useEffect(() => {
    ...
    allLessons.map((lesson) => {
      lessons.push({
        ...
        label: lesson.name,
        selccted: (questionDetails?.[QUESTION_LESSONSUID] || []).includes(
          lesson.lessonuid
        ),
      });
    });
  ...
  useEffect(() => {
    if (questionDetails != null) {
      ...
      $('#onlyassessmentswitch')
        .prop('checked', questionDetails[QUESTION_ONLYASSESSMENT])
        .trigger('change');
    ...
    top: 30px;"
        ...
        $(`#${index}_previousremove`).on('click', function (e) {
          ...
          var newQuestionImgURL = newQuestionDetails?.[
            QUESTION_IMAGEURLS
          ].splice(Number(this.id.replaceAll('_previousremove', '')), 1);
  ...
  function clearOption() {
    ...
    document.getElementById('selectoptionimage').src =
  ...
  useEffect(() => {
    ...
    setlessonchoices(
      new Choices($('#lessonsselect')[0], {
        ...
        classNames: {
          containerInner:
            'choices__inner choices__inner_flexheight form-control-solid border-0 rounded h-auto text-dark fw-bold text-sm',
  ...
  function initModal() {
    ...
    $('#onlyassessmentswitch').change(function () {
      if (this.checked) {
        ...
        $('#onlyassessment_text').text(
          'Question In Practice and Assessment Mode.'
        );
      }
    });
...
`;
  ...
  async function saveQuestion() {
    ...
    utility.info_alert(
      (questionDetails !== null ? 'Update?' : 'Add') + ' Question?',
      'Are you sure you want to continue?',
      'CONTINUE',
      'CANCEL',
      () => {
    ...
    var uploadQuestionImages = async function () {
      if (formatFiles.length > 0) {
        ...
        for (let imageFile of formatFiles) {
          ...
          var imageBS64 = imageFile.imagesrc
    ...
    var uploadSubject = async () => {
      ...
      var addorUpdateQuestion = await RequestaddorUpdateQuestion(
        questionData,
        log
      );
      utility.hideloading();
          ...
          <div className="row">
            ...
            <div className="fv-row mb-7 col-md-12">
              ...
              <select
                id="lessonsselect"
                multiple
                className="text-sm rounded  form-control form-control-solid"
              ></select>
            </div>
            <div className="fv-row mb-0 col-md-12">
              <label className="required fs-6 fw-semibold mb-2">Question</label>

              <textarea
                id="question"
                type="text"
                className="form-control form-control-solid fw-bold text-dark autosizetextarea"
              ...
              <div className="row">
                ...
                <div className="col-md-3">
                  ...
                  <div className="w-auto image-input image-input-outline  w-auto h-125px">
                    <img
                      id="selectoptionimage"
                      src="https://placehold.co/200"
                      className="image-input-wrapper w-auto mw-200px h-125px"
                    ></img>
                    <label
